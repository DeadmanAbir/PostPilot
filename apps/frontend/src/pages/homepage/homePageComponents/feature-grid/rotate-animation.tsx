  ...
  return (
    ...
    >
      ...
      >
        ...
        <CubeFace {...faces[1]} transform="translateZ(-80px) rotateY(180deg)" />
        <CubeFace {...faces[2]} transform="translateX(-80px) rotateY(-90deg)" />
        <CubeFace {...faces[3]} transform="translateX(80px) rotateY(90deg)" />
        <CubeFace {...faces[4]} transform="translateY(-80px) rotateX(90deg)" />
        <CubeFace {...faces[5]} transform="translateY(80px) rotateX(-90deg)" />
