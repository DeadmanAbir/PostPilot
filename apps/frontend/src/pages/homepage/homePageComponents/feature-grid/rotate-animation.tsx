  ...
  const OrbitAnimation = () => {
    ...
    const faces = [
      { 
        ...
        label: 'YouTube',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#FF0000]">
            <path 
              fill="currentColor" 
      ...
      { 
        ...
        label: 'Twitter',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#1DA1F2]">
            <path 
              fill="currentColor" 
      ...
      { 
        ...
        label: 'Docs',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#4285F4]">
            <path 
              fill="currentColor" 
      ...
      { 
        bgColor: 'bg-[#34A853]/20', 
        label: 'URL',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#34A853]">
            <path 
              fill="currentColor" 
      ...
      { 
        ...
        label: 'Post Pilot',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#EA4335]">
            <path 
              fill="currentColor" 
      ...
      { 
        bgColor: 'bg-[#FBBC05]/20', 
        label: 'AI',
        icon: () => (
          <svg viewBox="0 0 24 24" className="w-16 h-16 text-[#FBBC05]">
            <path 
              fill="currentColor" 
