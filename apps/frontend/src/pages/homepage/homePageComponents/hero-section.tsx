...
const HeroSection = () => {
  return (
    <div className=" w-full border-b-2 border-dotted">
      <section className="container mx-auto py-20 text-center  min-h-[95vh] bg-black flex flex-col items-center justify-center relative overflow-hidden border-r-[2px] border-l-2 border-dotted">
        <TileEffect />
        <motion.div 
