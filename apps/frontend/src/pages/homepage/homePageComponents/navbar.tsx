...
const Navbar = () => {
  ...
  return (
    <header className=" mx-auto h-16   fixed top-2 w-full    overflow-hidden z-[999]">
      <div
        className={`flex items-center justify-between  h-full max-w-7xl mx-auto transition-all duration-300 rounded-full  px-8  backdrop-blur-md ${scrolled ? "bg-blue-400/20" : ""} `}
      >
        <div className="flex items-center gap-2 text-3xl font-bold tracking-wider relative  translate-x-8">
          ...
          <img
            src="/logo.png"
            alt="Loogo"
            className="size-20 absolute -left-16"
          />
        </div>
