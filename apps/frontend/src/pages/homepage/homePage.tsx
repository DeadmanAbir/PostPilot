...
import HowItWorks from "./homePageComponents/how-it-works";
const HomePage = () => {
  return (
    <div className="min-h-screen bg-black relative  text-white  flex flex-col items-center justify-center  euclid overflow-hidden">
      ...
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/5 to-blue-900/15 absolute inset-0 z-0"></div>
      <Navbar />
