  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <h1 className="text-center text-slate-200 text-xl font-bold ">Regenerate Post</h1>



        <div className="bg-white  grid grid-cols-6 gap-2 rounded-xl p-2 text-sm">

          <textarea placeholder="Your feedback..." className="bg-slate-100 text-slate-600 h-28 placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 resize-none outline-none rounded-lg p-2 duration-300 focus:border-slate-600" value={currentPost} readOnly></textarea>
        ...
        <div className="flex items-center justify-end w-full ">
          <button onClick={handleRegenerate} className="bg-slate-100 stroke-slate-600 border border-slate-200 col-span-2 flex justify-center rounded-lg p-2 duration-300 hover:border-slate-600 hover:text-white focus:stroke-blue-200 focus:bg-blue-400">
