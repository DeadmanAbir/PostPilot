  ...
  return (
    <div className="rounded-lg border bg-card shadow-sm relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-700 border-none text-white">
      ...
      <div className="p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10">
        ...
        <Link
          to={href}
          className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-11 rounded-md px-8 bg-white hover:bg-blue-50 text-pilot-blue-700 text-blue-600"
        >
          <svg
